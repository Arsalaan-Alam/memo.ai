...
const New = () => {
    ...
    return (
        <div className="bg-black bg-cover bg-center" style={{ backgroundImage: "url('/assets/background.jpg')" }}>
            <nav className="mx-auto w-70vw py-4 px-6 flex justify-between items-center max-w-6xl" style={{ backgroundColor: "#6A5691" }}>
            ...
            <div className="flex justify-center mt-40 h-screen">
                <div className="text-center">
                    ...
                    <Link href="/choose">
                        <button className='text-white font-medium py-2 px-12 rounded text-white-500 mt-5 bg-green-700 transition duration-300 ease-in-out focus:outline-none focus:ring focus:border-white'>Get Started</button>
                    </Link>
                </div>
            </div>
            {showAdditionalText && (
